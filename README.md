...
```
**모든 학생 조회**  
학번 이름 평균 순으로 출력한다. 평균은 소수점 둘째 자리에서 반올림한다. 이름순을 선택하면 이름 오름차순, 평균순을 선택하면 평균 내림차순으로 출력한다.
```
12345678 홍길동 83.5
87654321 김철수 99.4   
```
...
### 각 클래스의 역할과 책임 준수
- **SOLID 원칙 중 SRP**를 최대한 준수하며 설계한다.(★★★★★)
